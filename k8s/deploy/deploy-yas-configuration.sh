...
--set-string backofficeBffExtraConfig.spring.security.oauth2.client.provider.keycloak.issuer-uri="$IDENTITY_URL/realms/Yas" \
...
--set-string storefrontBffExtraConfig.spring.security.oauth2.client.provider.keycloak.issuer-uri="$IDENTITY_URL/realms/Yas" \
